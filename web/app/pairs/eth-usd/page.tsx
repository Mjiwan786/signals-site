/**
 * ETH/USD Trading Pair Page
 * Live signals filtered for ETH/USD only
 */
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-purple-500/30 rounded-full mb-4">
            ...
            <span className="text-sm font-medium text-purple-400">Ethereum • Live Data</span>
          </div>

          <h1 className="text-4xl md:text-5xl font-display font-bold text-text mb-3">
            ETH/USD Trading Signals
          </h1>
          <p className="text-lg text-text2 max-w-2xl">
            AI-powered trading signals exclusively for Ethereum. Real-time data streamed via secure Redis connection.
          </p>
        </motion.div>
          ...
          <motion.section variants={fadeInUp} className="scroll-mt-24">
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-2xl font-bold text-text">ETH/USD Performance</h2>
              </div>
              <p className="text-dim">
                Track Ethereum trading performance across all timeframes
              </p>
            </div>
          ...
          <motion.section variants={fadeInUp}>
            <div className="glass-card rounded-2xl p-8 border-purple-500/20">
              <h3 className="text-xl font-bold text-text mb-6 flex items-center gap-2">
                ...
                About ETH/USD Signals
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-text2 mb-4">Why Ethereum?</h4>
                  <p className="text-sm text-dim mb-4">
                    Ethereum (ETH) is the second-largest cryptocurrency and the foundation for DeFi and NFTs. Our AI models capture its unique volatility patterns and market correlations.
                  </p>
...
export default function ETHUSDPage() {
  return (
    <PageErrorBoundary pageName="ETH/USD Signals" fallbackType="signals">
      <ETHUSDPageContent />
    </PageErrorBoundary>
  );
}
